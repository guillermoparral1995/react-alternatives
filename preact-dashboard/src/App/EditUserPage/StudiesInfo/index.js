...
const StudiesInfo = ({ dispatch, i18n: { getText, lang } }) => {
  ...
  return (
    <section className="form-section">
      ...
      <label htmlFor="university">{getText("edit-user-page_studies-info_university", lang)}</label>
      <input
        name="university"
      ...
      />
      <label htmlFor="career">{getText("edit-user-page_studies-info_career", lang)}</label>
      <input
        name="career"
      ...
      />
      <label htmlFor="finished">{getText("edit-user-page_studies-info_finished", lang)}</label>
      <input
        type="checkbox"
